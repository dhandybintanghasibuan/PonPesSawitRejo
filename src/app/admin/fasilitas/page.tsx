  ...
  export default function AdminFasilitasPage() {
    ...
    const [formData, setFormData] = useState<Fasilitas>({
      id: "",
      nama: "",
      deskripsi: "",
      gambar_url: "",
    ...
    const handleSubmit = async () => {
      ...
      const payload = { ...formData, gambar_url: imageUrl };
      let error;
    ...
    return (
      <section className="p-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-green-900">Kelola Fasilitas</h2>
          <button
            onClick={() => {
              resetForm();
