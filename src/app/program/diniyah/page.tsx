    ...
    <main className="min-h-screen bg-[#f9fafb]">
      ...
      <section className="relative bg-gradient-to-r from-[#0d4f9e] to-[#1560bd] text-white py-24 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          <GiTeacher className="text-6xl mx-auto mb-4 animate-pulse" />
          <h1 className="text-4xl md:text-5xl font-bold leading-tight">
            Program Pendidikan Diniyah
          </h1>
          <p className="mt-4 text-lg md:text-xl text-white/90">
            Pendidikan agama Islam mendalam yang mencakup fiqih, aqidah, akhlak,
            dan kitab kuning sebagai bekal dasar kehidupan Islami.
          </p>
        </div>
      ...
      <section className="relative z-10 py-16 px-6 max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="bg-white rounded-xl shadow-lg border-l-8 border-[#0d4f9e] p-8 transition-all duration-300 hover:shadow-xl">
          <h2 className="text-2xl font-bold text-[#0d4f9e] mb-6">
            Materi & Pendekatan Belajar
          </h2>
          <ul className="space-y-4 text-gray-700">
            {[
              "Pembelajaran Fiqih, Akidah, Akhlak, dan Tarikh",
              "Kitab kuning klasik dengan metode sorogan & bandongan",
              "Pembinaan adab santri dan praktik ibadah harian",
              "Ujian berkala dan talaqqi bersama ustadz",
              "Kelas terpisah sesuai jenjang usia dan pemahaman",
            ].map((item, index) => (
        ...
        <div className="rounded-xl overflow-hidden shadow-md hover:scale-105 transition duration-500">
          <Image
            src="/assets/img/diniyah.jpg"
            alt="Pembelajaran Diniyah"
            width={800}
            height={600}
